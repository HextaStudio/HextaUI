...
const backgroundparticles = () => {
  return (
    <>
      <DocsSEO
        title="Background Particles - hextastudio/ui"
        description="A animated background particles component."
        image="https://i.imgur.com/f5VFIKs.png"
      />
      <DocsLayout>
        <main>
          <DocsHeader
            ...
            description="A animated background particles component."
          />
          <DocsPreview className="min-h-[30rem]">
    ...
    <div className={className} ref={canvasContainerRef} aria-hidden="true">
      <canvas ref={canvasRef} className="h-full w-full" />
          ...
          <CodeBlock
            ...
            free
            title="Usage"
            code={`<div className="z-[1] text-center flex items-center justify-center w-full">
    <h1 className="text-4xl max-sm:text-3xl">hextastudio/ui</h1>
</div>
<div className="w-screen h-screen absolute">
    <BackgroundParticles quantity={300} />
