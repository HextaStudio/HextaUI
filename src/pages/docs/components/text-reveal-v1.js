...
export const TextRevealV1Preview = () => {
  ...
  return (
    <>
      ...
      >
        <p className="text-[3.6rem] max-[680px]:text-5xl max-[480px]:text-4xl max-[380px]:text-[2.2rem] max-[380px]:leading-[2rem] font-semibold tracking-tighter leading-[3.6rem] text-left">
